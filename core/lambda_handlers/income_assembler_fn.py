"""AWS Lambda entry point: income-assembly-queue.fifo -> income_assembler_fn."""
import asyncio
import json
import logging
...
def lambda_handler(event, context):
    from core.pipelines.income_pipeline import IncomePipeline

    service = _build_service()
    pipeline = IncomePipeline(service)
