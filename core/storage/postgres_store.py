    ...
    async def upsert_entity_state(
        ...
        await db.execute(
            ...
            INSERT INTO entity_states (
                ...
                loan_amount, interest_rate, ltv, cltv,
                dti_front, dti_back, piti_monthly, mi_monthly,
                monthly_obligations, existing_mortgage_payment,
            ...
            ON CONFLICT (application_id) DO UPDATE SET
                ...
                mi_monthly                      = EXCLUDED.mi_monthly,
                monthly_obligations             = EXCLUDED.monthly_obligations,
                existing_mortgage_payment       = EXCLUDED.existing_mortgage_payment,
            ...
            s.get("existing_mortgage_payment"),
